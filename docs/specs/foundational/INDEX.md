...
**Status (2026-04-27):** Phase 2 + Phase 3 (spec 16 finish) complete. See `FoxyBearOffice/docs/decisions/260427_foxybear_spec16-finish-retro.md`.

## Spec Files

### Phase 1 — Memory, scheduler, mesh, harness, rebrand (in this repo)
...
| 08 | [08_rebrand.md](08_rebrand.md) | Rebrand: OpenCode → FoxyBear | 6 | 15 |
| | **Phase 1 Total** | | | **128** |

### Phase 2 — Daemon, transports, persona, harness OS

Files live in `FoxyBearOffice/docs/`. Statement counts from the spec sources (one row per `WHEN ... SHALL ...` pair, except spec 16 which uses lettered task IDs).

| # | File | Component | Statements |
|---|------|-----------|-----------|
| 09 | [260418_foxybear_spec-daemon.md](../../../../../docs/260418_foxybear_spec-daemon.md) | Daemon shell — `foxybear serve`, PID, /health, /session | 24 |
| 10 | [260418_foxybear_spec-workforce-integration.md](../../../../../docs/260418_foxybear_spec-workforce-integration.md) | Memory hierarchy — instance/project/global tiers | 23 |
| 11 | [260418_foxybear_spec-persona-system.md](../../../../../docs/260418_foxybear_spec-persona-system.md) | Persona loading, frontmatter, tools.require/prefer | 16 |
| 12 | [260418_foxybear_spec-google-workspace-mcp.md](../../../../../docs/260418_foxybear_spec-google-workspace-mcp.md) | Google Workspace tools (Gmail, Calendar, Drive, etc.) | 25 |
| 13 | [260418_foxybear_spec-telegram-transport.md](../../../../../docs/260418_foxybear_spec-telegram-transport.md) | Telegram bot transport into daemon | 18 |
| 14 | [260418_foxybear_spec-spec-pipeline.md](../../../../../docs/260418_foxybear_spec-spec-pipeline.md) | Code-driven spec generation/validation | 14 |
| 15 | [260418_foxybear_spec-clean-room.md](../../../../../docs/260418_foxybear_spec-clean-room.md) | Worktree-isolated spec execution rooms | 15 |
| 16 | [260419_foxybear_spec-harness-os.md](../../../../../docs/260419_foxybear_spec-harness-os.md) | Harness OS — ELT pipeline, routing, mesh peer-query | 28 |
| | **Phase 2 Total** | | **163** |

### Phase 3 — Spec 16 finish (sub-specs)

Closing sub-specs that bound the original spec 16's abstract behaviors to concrete WHEN/SHALL. Files live in `FoxyBearOffice/docs/`.

| # | File | Component | Statements |
|---|------|-----------|-----------|
| 16-finish | [260421_foxybear_spec16-finish.md](../../../../../docs/260421_foxybear_spec16-finish.md) | Parent finish amendment (A-* runner, B-* persona, C-* mesh, D-* memory, E-* web UI deferred, F-* elevated) | 35 |
| 16-§D-kuzu | [260427_foxybear_spec-memory-backend-kuzu.md](../../../../../docs/260427_foxybear_spec-memory-backend-kuzu.md) | §D MemoryBackend contract (Kuzu impl superseded by SurrealDB) | 16 |
| 16-§D-surreal | [260427_foxybear_spec-surreal-graph-backend.md](../../../../../docs/260427_foxybear_spec-surreal-graph-backend.md) | SurrealGraphBackend (SG-01..SG-05) | 23 |
| 16-§C-live | [260427_foxybear_spec-mesh-live-round-trip.md](../../../../../docs/260427_foxybear_spec-mesh-live-round-trip.md) | Live two-daemon mesh peer-query round-trip (LR-01..LR-06) | 10 |
| 16-§F | [260427_foxybear_spec-elevated-privileges.md](../../../../../docs/260427_foxybear_spec-elevated-privileges.md) | Owner-elevated process flag (EP-01..EP-08) | 13 |

> The Phase 2 / Phase 3 entries above are the canonical contributor cross-reference. Phase 1 statement-by-statement detail follows below; Phase 2 / Phase 3 statement detail lives in each linked source file.
